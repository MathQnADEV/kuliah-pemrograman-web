...
@section('content')
    <header class="relative flex flex-col w-full h-[712px]">
        ...
        <div class="relative flex flex-col mt-[244px] gap-5 items-center">
            ...
            <h1 class="font-extrabold text-[46px] leading-[60px] text-center text-white">You Deserve Best Property in
                Makassar</h1>
                        ...
                        <a href="/category" class="card">
                            <div
                                ...
                                <div class="flex w-full h-[240px] overflow-hidden rounded-[30px]">
                                    <img src="{{ $category['thumbnail'] }}" class="w-full h-full object-cover"
                                        alt="thumbnails">
                                </div>
                                <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        ...
                                        <p class="font-semibold text-sm">{{ $category['house'] }} Houses</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="content flex flex-col gap-[30px] pt-[30px]">
                        @foreach ($testimonials as $testimonial)
                            <div
                                ...
                                <p class="font-semibold leading-[28px]">{{ $testimonial['message'] }}</p>
                                <div class="flex items-center gap-[14px]">
                                    <div class="flex size-[60px] rounded-full overflow-hidden">
                                        <img src="{{ $testimonial['photoProfile'] }}" class="w-full h-full object-cover"
                                            alt="photo profile">
                                    </div>
                                    <div>
                                        <p class="font-semibold">{{ $testimonial['name'] }}</p>
                                        <p class="text-sm text-tedja-secondary">{{ $testimonial['job'] }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="content flex flex-col gap-[30px] pt-[30px]">
                        @foreach ($testimonials as $testimonial)
                            <div
                                ...
                                <div class="flex items-center gap-[14px]">
                                    <div class="flex size-[60px] rounded-full overflow-hidden">
                                        <img src="{{ $testimonial['photoProfile'] }}"
