...
@section('content')
        <div class="mt-[164px] flex flex-col gap-5 text-center items-center">
            ...
            <h1 class="font-bold text-4xl leading-[54px]">Ayana Type Oleander</h1>
            <div class="flex items-center justify-center gap-5">
                <div class="flex items-center gap-[6px]">
                    <img src="{{ asset('assets/images/icons/location.svg') }}" class="size-6 flex shrink-0" alt="icon">
                    <p class="font-semibold">{{ $category['location'] }}</p>
                </div>
                <div class="flex items-center gap-[6px]">
        ...
        <section id="Gallery" class="flex gap-5 w-full max-w-[1280px] h-[450px] px-[75px] mt-[50px] mx-auto">
            <button class="show-modal-btn relative group flex w-full h-[450px] rounded-[30px] overflow-hidden">
                <img src="{{asset($category['image1'])}}" class="w-full h-full object-cover" alt="house thumbnail">
            ...
            <div class="grid grid-cols-2 gap-5 w-[450px] shrink-0">
                <button class="show-modal-btn relative group flex size-[215px] shrink-0 rounded-[22px] overflow-hidden">
                    <img src="{{asset($category['image2'])}}" class="w-full h-full object-cover" alt="house details">
                    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <img src="{{ asset('assets/images/icons/eye-white-fill.svg') }}" class="size-[50px]" alt="icon">
                    </div>
                </button>
            ...
            <div class="flex items-center justify-between rounded-[20px] border border-tedja-border py-5 px-[30px] bg-white">
                <div class="flex flex-col w-fit gap-3">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="font-semibold">{{ $category['bedroom'] }} Bedroom</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col w-fit gap-3">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/images/icons/slider-vertical.svg') }}" class="size-6 flex shrink-0" alt="icon">
                        <p class="font-semibold">{{ $category['bathroom'] }} Bathroom</p>
                    </div>
                </div>
                <div class="h-[60px] border border-tedja-border"></div>
                <div class="flex flex-col w-fit gap-3">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="font-semibold">{{ $category['certificate'] }}</p>
                    </div>
                </div>
                <div class="h-[60px] border border-tedja-border"></div>
                <div class="flex flex-col w-fit gap-3">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="font-semibold">{{ $category['landArea'] }}</p>
                    </div>
                </div>
                <div class="h-[60px] border border-tedja-border"></div>
                <div class="flex flex-col w-fit gap-3">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="font-semibold">{{ $category['landBuilding'] }}</p>
                    </div>
                </div>
                <div class="h-[60px] border border-tedja-border"></div>
                <div class="flex flex-col w-fit gap-3">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="font-semibold">{{ $category['electricPower'] }} Watt</p>
                    </div>
                </div>
            </div>
        </section>
        <section id="Details" class="w-full flex gap-[70px] max-w-[1280px] px-[75px] my-[50px] mx-auto">
                ...
                <div id="Nerby-Facilities" class="flex flex-col gap-[14px]">
                    ...
                    <div class="grid grid-cols-4 gap-5">
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/hospital-red.svg') }}" class="size-8 flex shrink-0" alt="icon">
                            <p class="font-semibold">Public Hospital</p>
                        </div>
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/shop-orange.svg') }}" class="size-8 flex shrink-0" alt="icon">
                            <p class="font-semibold">All Best Restaurants</p>
                        </div>
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/security-user-purple.svg') }}" class="size-8 flex shrink-0" alt="icon">
                            <p class="font-semibold">Professional Securities</p>
                        </div>
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/shopping-bag-green.svg') }}" class="size-8 flex shrink-0" alt="icon">
                            <p class="font-semibold">Shopping Mall</p>
                        </div>
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/cards-green.svg') }}" class="size-8 flex shrink-0" alt="icon">
                            <p class="font-semibold">Financial Center</p>
                        </div>
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/buildings-blue.svg') }}" class="size-8 flex shrink-0" alt="icon">
                            <p class="font-semibold">Central Business</p>
                        </div>
                        <div class="flex flex-col min-h-[140px] rounded-[20px] border border-tedja-border p-5 gap-5 bg-white">
                            <img src="{{ asset('assets/images/icons/book-cyan.svg') }}" class="size-8 flex shrink-0" alt="icon">
                ...
                <div id="Location" class="flex flex-col gap-[14px]">
                    ...
                    <div class="overflow-hidden w-full h-[320px]">
                        <div id="my-map-display" class="h-full w-full max-w-[none] bg-none">
                            <iframe class="h-full w-full border-0" frameborder="0" src="{{ $category['locationMap'] }}"></iframe>
                        </div>
            ...
            <div class="flex flex-col w-[400px] shrink-0 h-fit rounded-[30px] border border-tedja-border p-5 gap-5 bg-white">
                <p class="font-bold text-[38px] leading-[57px] text-center text-tedja-blue">Rp {{ $category['price']}}</p>
                ...
                <div class="group flex items-center justify-between rounded-[20px] ring-1 ring-tedja-border p-4 bg-white hover:ring-2 hover:ring-tedja-blue transition-all duration-300">
                    <div class="flex items-center gap-[14px]">
                        <div class="flex items-center w-[71px] h-[50px] shrink-0 overflow-hidden">
                            <img src="{{ asset('assets/images/logos/dbs.svg') }}" class="w-full h-full object-contain" alt="bank logo">
                        </div>
                        <div>
