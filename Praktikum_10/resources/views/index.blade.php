    ...
    <body>
        ...
        <header class="relative flex flex-col w-full h-[712px]">
            ...
            <div class="relative flex flex-col mt-[244px] gap-5 items-center">
                ...
                <h1 class="font-extrabold text-[46px] leading-[60px] text-center text-white">You Deserve Best Property in Makassar</h1>
            ...
            <form action="/category" class="relative flex w-full max-w-[940px] rounded-3xl p-5 gap-5 bg-white border border-tedja-border shadow-[0px_8px_30px_0px_#06092208] mx-auto mt-auto">
                ...
                <div class="flex flex-col w-full max-w-[227px] gap-2 h-[84px]">
                    ...
                    <label class="relative">
                        <select name="" id="" class="appearance-none outline-none w-full rounded-full ring-1 ring-tedja-black py-[14px] px-5 font-semibold invalid:font-normal focus:ring-2 focus:ring-tedja-blue transition-all duration-300" required>
                            ...
                            <option value="1">Pesisir Pantai</option>
                            <option value="1">Bukit</option>
                ...
                <button type="submit" class="group rounded-full border py-[14px] px-5 flex items-center bg-tedja-green mt-auto">
                    <span class="font-semibold text-nowrap">Find Property</span>
                </button>
            </form>
        </header>
                        ...
                        <a href="/category" class="card">
                            <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-tedja-border bg-white p-[10px] gap-4 hover:ring-2 hover:ring-tedja-blue transition-all duration-300">
                                ...
                                <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                                    <h3 class="font-bold text-lg">Pesisir Pantai</h3>
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/house-2.svg" class="size-5 flex shrink-0" alt="icon">
                                        <p class="font-semibold text-sm">0 Houses</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                        <a href="/category" class="card">
                            <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-tedja-border bg-white p-[10px] gap-4 hover:ring-2 hover:ring-tedja-blue transition-all duration-300">
                                ...
                                <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                                    <h3 class="font-bold text-lg">Bukit</h3>
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/house-2.svg" class="size-5 flex shrink-0" alt="icon">
                                        <p class="font-semibold text-sm">0 Houses</p>
                                    </div>
                    ...
                    <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                        <a href="/category" class="card">
                            <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-tedja-border bg-white p-[10px] gap-4 hover:ring-2 hover:ring-tedja-blue transition-all duration-300">
                                ...
                                <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                                    <h3 class="font-bold text-lg">Desa</h3>
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/house-2.svg" class="size-5 flex shrink-0" alt="icon">
                                        <p class="font-semibold text-sm">1 Property</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                        <a href="/category" class="card">
                            <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-tedja-border bg-white p-[10px] gap-4 hover:ring-2 hover:ring-tedja-blue transition-all duration-300">
                                ...
                                <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                                    <h3 class="font-bold text-lg">Perumahan</h3>
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/house-2.svg" class="size-5 flex shrink-0" alt="icon">
                                        <p class="font-semibold text-sm">1 Houses</p>
                                    </div>
                                </div>
                            </div>
                        </a>
